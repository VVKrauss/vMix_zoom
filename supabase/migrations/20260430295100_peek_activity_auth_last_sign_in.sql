-- Подстановка «последней активности» из auth.last_sign_in_at, если в public.users нет heartbeat/last_login
...
begin
  ...
  from unnest(array[r.last_active_at, r.last_login_at, r.last_sign_in_at]) as t(x)
  where x is not null;
